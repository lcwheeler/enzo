...
class PathwaySetFlex(object):
    ...
    def evolve(self, params, W_func, W_func_args, mutation_func, mutation_func_args, optimum_tolerance, iterations, stop, MCA):
        ...
        if self.evolved == False: 
            ...
            for i in range(len(self.pathway_set.keys())):
                self.pathway_set[i].evolve(params, W_func, W_func_args, mutation_func, mutation_func_args, optimum_tolerance, iterations, stop, MCA)
